...
/**
 * Workspace overview shown at `/dashboard`. Mirrors the prior `/account`
 * design so owners see the same familiar tiles, but all internal links are
 * rewritten to the new `/dashboard/*` tree.
 */
export function DashboardOverview({ summary }: { summary: AccountSummary }) {
  const tiles = [
    {
