...
export default async function RegisterPage({ searchParams }: { searchParams: Promise<{ invite?: string }> }) {
  ...
  return (
    <AuthShell eyebrow={inviteToken ? "You’re invited" : "Get started"} title="Create your workspace" description={inviteToken ? "Finish a few details to join your organisation’s CodeVenture workspace." : "Tell us a little about yourself and your secure client workspace will be ready."}
